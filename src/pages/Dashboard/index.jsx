                                    ...
                                    <div className="flex justify-center rounded-[15px]  p-[30px] bg-color ">
                                        <div className="mb-[19px] mt-[23px] flex-col items-start gap-[33px]">
                                            <div className="flex flex-col items-start gap-3.5">
                                                ...
                                                <Text as="p" className="tracking-[0.14px] text-white-A700_cc">
                                            ...
                                            <div className="flex gap-5">
                                                <Button
                                                    color="white_A700"
                                                    size="3xl"
                                                    className=" bg-white min-w-[120px] rounded-lg font-semibold tracking-[0.14px]"
                                                >
                                                    Explore More
                                                </Button>
                                                <Button
                                                    ...
                                                    size="3xl"
                                                    variant="outline"
                                                    className="min-w-[120px] text-white rounded-lg font-semibold tracking-[0.14px]"
                                                >
                                                    Sell Artwork
                                                </Button>
                                            </div>
                                    ...
                                    <div className="flex flex-col items-center gap-[11px] rounded-[15px] bg-white-A700 p-1.5 shadow-md">
                                        ...
                                        <div className="flex items-center justify-between gap-5 self-stretch">
                                            ...
                                            <Button
                                                ...
                                                size="xs"
                                                shape="round"
                                                className="min-w-[64px] font-outfit tracking-[0.12px]"
                                            >
                                                Follow
                                            </Button>
                                        </div>
                                ...
                                <div className="mb-[15px] flex flex-col gap-[18px]">
                                    ...
                                    <div className="flex flex-col gap-[19px]">
                                        ...
                                        <div className="flex flex-1 items-center justify-between gap-5">
                                            <div className="flex w-[66%] items-center justify-center gap-3.5">
                                                <img
                                                    src="images/img_ellipse_1018_2.png"
                                                    alt="circleimage"
                                                    className="h-[42px] w-[42px] rounded-[50%]"
                                        ...
                                        <div className="h-px w-full bg-gray-100" />
                                        <div className="flex flex-1 items-center justify-between gap-5">
                                            <div className="flex w-[60%] items-center justify-center gap-3.5">
                                                <Img
